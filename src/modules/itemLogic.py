...
class ModifierType(Enum):
    ...
    #X Attack
    X_ATTACK = Modifier(args=[0, 5], className='TempBattleStatBoosterModifier', player=True, stackCount=1, typeId='TEMP_STAT_BOOSTER', typePregenArgs=[0], description='', customName='X Attack', customType='XItem', maxStack='')
    X_DEFENSE = Modifier(args=[1, 5], className='TempBattleStatBoosterModifier', player=True, stackCount=1, typeId='TEMP_STAT_BOOSTER', typePregenArgs=[1], description='', customName='X Defense', customType='XItem', maxStack='')
    X_SP_ATK = Modifier(args=[2, 5], className='TempBattleStatBoosterModifier', player=True, stackCount=1, typeId='TEMP_STAT_BOOSTER', typePregenArgs=[2], description='', customName='X Special Attack', customType='XItem', maxStack='')
    X_SP_DEF = Modifier(args=[3, 5], className='TempBattleStatBoosterModifier', player=True, stackCount=1, typeId='TEMP_STAT_BOOSTER', typePregenArgs=[3], description='', customName='X Special Defense', customType='XItem', maxStack='')
    X_SPEED = Modifier(args=[4, 5], className='TempBattleStatBoosterModifier', player=True, stackCount=1, typeId='TEMP_STAT_BOOSTER', typePregenArgs=[4], description='', customName='X Speed', customType='XItem', maxStack='')
    X_ACCURACY = Modifier(args=[5, 5], className='TempBattleStatBoosterModifier', player=True, stackCount=1, typeId='TEMP_STAT_BOOSTER', typePregenArgs=[5], description='', customName='X Accuracy', customType='XItem', maxStack='')
    X_DIRE_HIT = Modifier(args=[6, 5], className='TempBattleStatBoosterModifier', player=True, stackCount=1, typeId='TEMP_STAT_BOOSTER', typePregenArgs=[6], description='', customName='X Dire Hit', customType='XItem', maxStack='')
    # Berrys
    APICOT_BERRY = Modifier(args=[None, 6], className='BerryModifier', player=True, stackCount=1, typeId='BERRY', typePregenArgs=[6], description='Raises Sp. Def if HP is below 25%.', customName='Apicot Berry', customType='Berry', maxStack='3')
    ENIGMA_BERRY = Modifier(args=[None, 2], className='BerryModifier', player=True, stackCount=1, typeId='BERRY', typePregenArgs=[2], description='Restores 25% HP if hit by a super effective move. ', customName='Enigma Berry', customType='Berry', maxStack='2')
    GANLON_BERRY = Modifier(args=[None, 4], className='BerryModifier', player=True, stackCount=1, typeId='BERRY', typePregenArgs=[4], description='Raises Defense if HP is below 25%. ', customName='Ganlon Berry', customType='Berry', maxStack='3')
    LANSAT_BERRY = Modifier(args=[None, 8], className='BerryModifier', player=True, stackCount=1, typeId='BERRY', typePregenArgs=[8], description='Raises critical hit ratio if HP is below 25%. ', customName='Lansat Berry', customType='Berry', maxStack='3')
    LIECHI_BERRY = Modifier(args=[None, 3], className='BerryModifier', player=True, stackCount=1, typeId='BERRY', typePregenArgs=[3], description='	Raises Attack if HP is below 25%. ', customName='Liechi Berry', customType='Berry', maxStack='3')
    LEPPA_BERRY = Modifier(args=[None, 10], className='BerryModifier', player=True, stackCount=1, typeId='BERRY', typePregenArgs=[10], description='Restores 10 PP to a move if its PP reaches 0. ', customName='Leppa Berry', customType='Berry', maxStack='2')
    LUM_BERRY = Modifier(args=[None, 1], className='BerryModifier', player=True, stackCount=1, typeId='BERRY', typePregenArgs=[1], description='Cures any non-volatile status condition and confusion ', customName='Lum Berry', customType='Berry', maxStack='2') 
    ...
    STARF_BERRY = Modifier(args=[None, 9], className='BerryModifier', player=True, stackCount=1, typeId='BERRY', typePregenArgs=[9], description='Sharply raises a random stat if HP is below 25%. ', customName='Starf Berry', customType='Berry', maxStack='3')
    BERRY_POUCH = Modifier(args=None, className='PreserveBerryModifier', player=True, stackCount=1, typeId='BERRY_POUCH', description='Adds a 30%/ chance that a used berry will not be consumed. ', customName='Berry Pouch', customType='Berry', maxStack='')
    # Passive Boosts
    GOLDEN_POKEBALL = Modifier(args=None, className='ExtraModifierModifier', player=True, stackCount=1, typeId='GOLDEN_POKEBALL', description='Adds 1 extra item option at the end of every battle.', customName='Golden Pokeball', customType='PassiveBoost', maxStack='3')
    AMULET_COIN = Modifier(args=None, className='MoneyMultiplierModifier', player=True, stackCount=1, typeId='AMULET_COIN', description='Increases money rewards from all sources by 20%.', customName='Amulet Coin', customType='PassiveBoost', maxStack='5')                                                                 
    LOCK_CAPSULE = Modifier(args=None, className='LockModifierTiersModifier', player=True, stackCount=1, typeId='LOCK_CAPSULE', description='Allows you to lock item rarities when rerolling items.', customName='Lock Capsule', customType='PassiveBoost', maxStack='1')
    CANDY_JAR = Modifier(args=None, className='LevelIncrementBoosterModifier', player=True, stackCount=1, typeId='CANDY_JAR', description='Increases the number of levels added by Rare Candy items by 1.', customName='Candy Jar', customType='PassiveBoost', maxStack='99')
    EXP_SHARE = Modifier(args=None, className='ExpShareModifier', player=True, stackCount=1, typeId='EXP_SHARE', description='Non-participants receive 20%/ of a single participant\'s EXP. Points.', customName='EXP Share', customType='PassiveBoost', maxStack='5')
    EXP_BALANCE = Modifier(args=None, className='ExpBalanceModifier', player=True, stackCount=1, typeId='EXP_BALANCE', description='Balances 20%/ of your total earned exp towards the lowest leveled party member(s).', customName='EXP Balance', customType='PassiveBoost', maxStack='4')
    EXP_CHARM = Modifier(args=[25], className='ExpBoosterModifier', player=True, stackCount=1, typeId='EXP_CHARM', description='Increases gain of EXP. Points by 25%.', customName='EXP Charm', customType='PassiveBoost', maxStack='99')
    SUPER_EXP_CHARM = Modifier(args=[None], className='ExpBoosterModifier', player=True, stackCount=1, typeId='SUPER_EXP_CHARM', description='Increases gain of EXP. Points by 60%. ', customName='Super EXP Charm', customType='PassiveBoost', maxStack='30')
    GOLDEN_EXP_CHARM = Modifier(args=[None], className='ExpBoosterModifier', player=True, stackCount=1, typeId='GOLDEN_EXP_CHARM', description='Increases gain of EXP. Points by 100%. ', customName='Golden EXP Charm', customType='PassiveBoost', maxStack='10')
    SHINY_CHARM = Modifier(args=None, className='ShinyRateBoosterModifier', player=True, stackCount=1, typeId='SHINY_CHARM', description='Dramatically increases the chance of a wild Pokémon being Shiny.', customName='Shiny Charm', customType='PassiveBoost', maxStack='4')
    ABILITY_CHARM = Modifier(args=None, className='HiddenAbilityRateBoosterModifier', player=True, stackCount=1, typeId='ABILITY_CHARM', description='Dramatically increases the chance of a wild Pokémon having a Hidden Ability.', customName='Ability Charm', customType='PassiveBoost', maxStack='3')                                                    
    IV_SCANNER = Modifier(args=None, className='IvScannerModifier', player=True, stackCount=1, typeId='IV_SCANNER', description='	Allows scanning the IVs of wild Pokémon. 2 IVs are revealed per stack. The best IVs are shown first.', customName='', customType='PassiveBoost', maxStack='1')
    ...
    HEALING_CHARM = Modifier(args=[1.1], className='HealingBoosterModifier', player=True, stackCount=1, typeId='HEALING_CHARM', description='Increases the effectiveness of HP restoring moves and items by 10% (excludes Revives).', customName='IV Scanner', customType='PassiveBoost', maxStack='5')
    # Other holdables
    ...
    BATON = Modifier(args=[None], className='SwitchEffectTransferModifier', player=True, stackCount=1, typeId='BATON', description='Allows passing along effects when switching Pokémon, which also bypasses traps.', customName='Baton', customType='OtherHoldable', maxStack='1')
    FOCUS_BAND = Modifier(args=[None], className='SurviveDamageModifier', player=True, stackCount=1, typeId='FOCUS_BAND', description='Adds a 10%/ chance to survive with 1 HP after being damaged enough to faint.', customName='Focus Band', customType='OtherHoldable', maxStack='4')
    GRIP_CLAW = Modifier(args=[None, 10], className='ContactHeldItemTransferChanceModifier', player=True, stackCount=1, typeId='GRIP_CLAW', description='Upon attacking, there is a 10%/ chance the foe\'s held item will be stolen.', customName='Grip Claw', customType='OtherHoldable', maxStack='5')
    QUICK_CLAW = Modifier(args=[None], className='BypassSpeedChanceModifier', player=True, stackCount=1, typeId='QUICK_CLAW', description='Adds a 10percent chance to move first regardless of speed (after priority)', customName='Quick Claw', customType='OtherHoldable', maxStack='3')
    KINGS_ROCK = Modifier(args=[None], className='FlinchChanceModifier', player=True, stackCount=1, typeId='KINGS_ROCK', description='Adds a 10%/ chance an attack move will cause the opponent to flinch.', customName='Kings Rock', customType='OtherHoldable', maxStack='3')
    ...
    FORM_CHANGE_ITEM0 = Modifier(args=[None, 0, True], className='PokemonFormChangeItemModifier', player=True, stackCount=1, typeId='FORM_CHANGE_ITEM', typePregenArgs=[0], description='Causes certain Pokémon to change form.', customName='FormChangeItem', customType='FormChanger', maxStack='1')
    ...
    SOOTHE_BELL = Modifier(args=[None], className='PokemonFriendshipBoosterModifier', player=True, stackCount=1, typeId='SOOTHE_BELL', description='Increases friendship gain per victory by 50%.', customName='Soothe Bell', customType='Other Holdable', maxStack='3')
    SOUL_DEW = Modifier(args=[None], className='PokemonNatureWeightModifier', player=True, stackCount=1, typeId='SOUL_DEW', description='Increases the influence of a Pokémon\'s nature on its stats by 10% (additive).', customName='Soul Dew', customType='OtherHoldable', maxStack='10')
    MULTI_LENS = Modifier(args=[None], className='PokemonMultiHitModifier', player=True, stackCount=1, typeId='MULTI_LENS', description='Attacks hit one additional time at the cost of a 60/75/82.5% power reduction per stack respectively.', customName='Multi Lens', customType='OtherHoldable', maxStack='3')
    MINI_BLACK_HOLE = Modifier(args=[None], className='TurnHeldItemTransferModifier', player=True, stackCount=1, typeId='MINI_BLACK_HOLE', description='Every turn, the holder acquires one held item from the foe.', customName='Mini Black Hole', customType='OtherHoldable', maxStack='1')
